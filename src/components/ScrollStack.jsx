...
const ScrollStack = ({
  ...
  const updateCardTransforms = useCallback(() => {
    ...
    const endElement = useWindowScroll
      ...
      : (scrollerRef.current && scrollerRef.current.querySelector('.scroll-stack-end'));
  ...
  }, [itemDistance, itemScale, itemStackDistance, stackPosition, scaleEndPosition, baseScale, rotationAmount, blurAmount, useWindowScroll, setupLenis, updateCardTransforms]);

  return (
    <div className={'scroll-stack-scroller ' + (className || '').trim()} ref={scrollerRef} data-window-scroll={useWindowScroll ? 'true' : undefined}>
